...
import FeaturedMovie from '../components/Inside-page/FeaturedMovie'
import Header from '../components/Inside-page/Header'
import styles from './styles.module.scss'
import Tmdb, {Categoria} from '../components/Inside-page/Tmdb'
import {FilmeInfo} from '../components/Inside-page/FeaturedMovie'
import MovieRow from '../components/Inside-page/MovieRow'
